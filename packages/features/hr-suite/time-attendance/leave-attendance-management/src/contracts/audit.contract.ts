...
export const leaveAttendanceManagementAuditEvents = {
  ...
  workCalendarCreated: "lam.work-calendar.created",
  workCalendarUpdated: "lam.work-calendar.updated",
  holidayCalendarCreated: "lam.holiday-calendar.created",
  holidayCalendarUpdated: "lam.holiday-calendar.updated",
  attendancePolicyCreated: "lam.attendance-policy.created",
  attendancePolicyUpdated: "lam.attendance-policy.updated",
  leaveEncashmentPolicyCreated: "lam.leave-encashment-policy.created",
  leaveEncashmentPolicyUpdated: "lam.leave-encashment-policy.updated",
  leaveEncashmentProcessed: "lam.leave-encashment.processed",
...
export const leaveAttendanceManagementAuditEventGroups = [
  ...
  },
  {
    ...
    events: [
      ...
      leaveAttendanceManagementAuditEvents.leaveEncashmentProcessed,
