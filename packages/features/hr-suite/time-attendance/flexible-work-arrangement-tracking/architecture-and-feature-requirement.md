...
| --- | --- | --- |
| HRM-FWA-001 | Partial | [`src/contract.ts`](./src/contract.ts) |
| HRM-FWA-002 | Partial | [`src/actions.ts`](./src/actions.ts), [`src/execution/action.ts`](./src/execution/action.ts), [`src/queries.ts`](./src/queries.ts) |
| HRM-FWA-003 | Not started | [`src/queries.ts`](./src/queries.ts), [`src/actions.ts`](./src/actions.ts) |
...
1. `pnpm --filter @repo/features-time-attendance-flexible-work-arrangement-tracking typecheck`
2. `pnpm --filter @repo/features-time-attendance-flexible-work-arrangement-tracking lint`
