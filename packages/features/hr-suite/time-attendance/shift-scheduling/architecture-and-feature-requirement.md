...
| --- | --- | --- |
| HRM-SFT-001 | Partial | [`src/contract.ts`](./src/contract.ts) |
| HRM-SFT-002 | Partial | [`src/actions.ts`](./src/actions.ts), [`src/execution/action.ts`](./src/execution/action.ts), [`src/queries.ts`](./src/queries.ts) |
| HRM-SFT-003 | Not started | [`src/queries.ts`](./src/queries.ts), [`src/actions.ts`](./src/actions.ts) |
...
1. `pnpm --filter @repo/features-time-attendance-shift-scheduling typecheck`
2. `pnpm --filter @repo/features-time-attendance-shift-scheduling lint`
