...
| --- | --- | --- |
| HRM-FHC-001 | Partial | [`src/contract.ts`](./src/contract.ts) |
| HRM-FHC-002 | Partial | [`src/actions.ts`](./src/actions.ts), [`src/execution/action.ts`](./src/execution/action.ts), [`src/queries.ts`](./src/queries.ts) |
| HRM-FHC-003 | Not started | [`src/queries.ts`](./src/queries.ts), [`src/actions.ts`](./src/actions.ts) |
...
1. `pnpm --filter @repo/features-industry-specific-food-handler-certification-health-compliance typecheck`
2. `pnpm --filter @repo/features-industry-specific-food-handler-certification-health-compliance lint`
