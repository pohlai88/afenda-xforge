...
export const PRODUCT_SHORTCUT_DEFINITIONS: readonly ProductShortcutDefinition[] =
  [
    ...
    {
      actionId: "workspace.newTodo",
      defaultBinding: binding("mod+n"),
      group: "navigation",
      scope: "global",
      locked: false,
    ...
    {
      actionId: "workspace.newProject",
      defaultBinding: binding("mod+p"),
      group: "navigation",
      scope: "global",
      locked: false,
    ...
    {
      actionId: "workspace.openLynx",
      defaultBinding: binding("mod+l"),
      group: "navigation",
      scope: "global",
      locked: false,
      description: "Open Lynx",
      reliability: "low",
      browserConflict: true,
    },
    {
