...
const steps = [
  {
    ...
    content: "Account setup is ready.",
  },
  {
    step: 2,
    title: "Profile",
    description: "Add profile metadata.",
    content: "Profile setup is underway.",
  },
  {
    step: 3,
    title: "Review",
    description: "Verify everything before release.",
    content: "Review is the last step.",
  },
];

export function StepperInlineTitleDescription() {
  return (
