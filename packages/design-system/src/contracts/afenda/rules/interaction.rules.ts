...
import { AFENDA_GOV_INTERACTION } from "../catalogs/governance-reference.catalog";
...
export const AFENDA_INTERACTION_RULES = [
  {
    ...
    references: [AFENDA_GOV_INTERACTION, "WCAG:1.4.11"],
    enforcement: MANUAL,
  },
  {
  ...
  },
  {
    ...
    references: [AFENDA_GOV_INTERACTION, "WCAG:1.4.13", "WCAG:2.1.1"],
    enforcement: MANUAL,
  },
  {
    ...
    references: [AFENDA_GOV_INTERACTION, "WCAG:1.4.13"],
    enforcement: HYBRID,
  },
  {
    ...
    references: [AFENDA_GOV_INTERACTION, "WCAG:2.5.2"],
    enforcement: HYBRID,
  },
  {
    ...
    references: [AFENDA_GOV_INTERACTION, "WCAG:2.5.8"],
    enforcement: HYBRID,
  },
  {
    ...
    references: [AFENDA_GOV_INTERACTION],
    enforcement: MANUAL,
  },
  {
    ...
    references: [AFENDA_GOV_INTERACTION, "WCAG:3.2.1"],
    enforcement: HYBRID,
  },
