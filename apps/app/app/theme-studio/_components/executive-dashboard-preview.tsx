    ...
    <PreviewPageShell>
            ...
            <CardHeader>
              <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
                ...
                <div className="flex flex-wrap gap-2">
                  <Badge className="bg-chart-1/15 text-foreground" variant="outline">
                    Revenue
                  </Badge>
                  <Badge className="bg-chart-2/15 text-foreground" variant="outline">
                    Margin
                  </Badge>
                </div>
              </div>
              ...
              {approvals.map((item) => (
                ...
                >
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <Badge size="sm" variant={APPROVAL_BADGE_VARIANT[item.status]}>
                      {item.status}
                    </Badge>
                  </div>
                  ...
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className="font-medium text-tabular">{item.amount}</span>
                  </div>
                </div>
              ))}
            </CardContent>
              ...
              {activityFeed.map((item) => (
                ...
                >
                  ...
                  <div className="flex shrink-0 flex-col items-end gap-1.5">
                    <Badge size="sm" variant={ACTIVITY_BADGE_VARIANT[item.status]}>
                      {item.status}
                    </Badge>
            ...
            <CardContent className="grid gap-3 sm:grid-cols-2">
              {[
                ...
                >
                  ...
                  <p className="mt-2 font-semibold text-2xl tracking-tight text-tabular">
                    {widget.value}
                  </p>
              ...
              {ERP_VISUAL_LANES.map((lane) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    <span
                      className={cn("size-2.5 rounded-full", LANE_DOT_CLASS[lane.id])}
                    />
        ...
        <Card className="shadow-sm">
          <CardHeader>
            ...
            <CardDescription>
              Page 1 executive dashboard — 35% weight in the Theme Studio scorecard.
            </CardDescription>
          </CardHeader>
