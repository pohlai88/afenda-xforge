    ...
    <div className="space-y-6">
      <div className="space-y-2">
        ...
        <p className="max-w-3xl text-muted-foreground text-sm leading-6">
          HR Suite feature surface — select another module in the site sidebar
          to preview scope and breadcrumb wiring.
        </p>
      </div>
      ...
      {activeFeature.liveHref ? (
        <div className="flex flex-wrap gap-3">
          ...
          <Button asChild variant="outline">
            <Link href="/theme-studio/workspace-rail">
              Stay on workspace rail
            </Link>
          </Button>
        </div>
      ) : (
      ...
      <section className="space-y-3 border-border border-t pt-6">
        ...
        <ul className="grid gap-2 text-sm sm:grid-cols-2">
          <li>
            ...
            HR Suite breadcrumb — feature, domain, active module
          </li>
          <li>
            <Badge className="mr-2" variant="outline">
              site-sidebar
            </Badge>
            HR Suite header + domain groups + standard feature labels
          </li>
          <li>
            <Badge className="mr-2" variant="outline">
              site-content
