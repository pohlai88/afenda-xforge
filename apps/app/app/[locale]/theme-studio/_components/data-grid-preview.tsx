...
const METRIC_CARDS: {
  ...
  { title: "Total records", value: "12,840", note: "+420 this month", tone: "primary" },
  { title: "Pending review", value: "384", note: "Requires attention", tone: "warning" },
  { title: "Blocked", value: "27", note: "Action required", tone: "destructive" },
  { title: "Healthy", value: "96.4%", note: "Operationally clear", tone: "success" },
];
...
function matchesFilter(row: CustomerRow, filter: FilterId): boolean {
  switch (filter) {
    ...
    case "recent":
      return row.lastActivity.includes("hour") || row.lastActivity === "Yesterday";
    default:
      return true;
  }
}
        ...
        <Card className="overflow-hidden shadow-sm" {...densityAttr}>
          ...
          <CardContent className="min-w-0 p-0">
            <ScrollArea className="h-[34rem] w-full">
              <table
                className="min-w-[1040px] w-full caption-bottom text-sm"
                data-slot="table"
              >
                ...
                {visibleRows.length === 0 ? (
                  ...
                  visibleRows.map((row) => (
                    ...
                    >
                      ...
                      <TableCell>
                        <Badge
                          className={cn("capitalize", LANE_PILL_CLASS[row.lane])}
                          size="sm"
                          variant="outline"
                        >
