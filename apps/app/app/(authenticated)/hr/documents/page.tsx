          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <p className="max-w-3xl text-muted-foreground">
                ...
                files. The active backend is resolved from the storage provider
                configuration and each upload is registered with its storage
        ...
        <div className="mt-8 rounded-[var(--radius-xl)] border border-border bg-background/80 p-6 shadow-sm">
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
            ...
            <div className="rounded-lg border border-border/70 bg-card/80 p-4">
              ...
              <p className="font-medium text-sm">{data.loadedDocumentCount}</p>
            </div>
            <div className="rounded-lg border border-border/70 bg-card/80 p-4">
              <p className="text-muted-foreground text-xs uppercase tracking-[0.2em]">
                Sensitive access
        ...
        <section className="rounded-[var(--radius-xl)] border border-border bg-card/95 p-6 shadow-sm">
          <div className="space-y-2">
            ...
            <p className="max-w-3xl text-muted-foreground text-sm">
              The document list is visible, but upload calls stay disabled until
              the runtime tenant role has write access.
            </p>
          </div>
        </section>
      )}
