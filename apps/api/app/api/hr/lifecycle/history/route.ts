import { listEmployeeLifecycleHistoryEntries } from "@repo/features-employee-management-employee-lifecycle-management/server";
...
export async function GET(request: Request) {
  ...
  const data = listEmployeeLifecycleHistoryEntries(
    query.employeeId,
